...
class NSmlDmURI
	...
	* @return 		 		Parent URI
	*/
	IMPORT_C static TPtrC8 ParentURI(const TDesC8& aURI);
	...
	*/
	IMPORT_C static TPtrC8 LastURISeg(const TDesC8& aURI);
	...
	* @return 		 		Uri without ./
	*/
	IMPORT_C static TPtrC8 RemoveDotSlash(const TDesC8& aURI);
	...
	*/
	IMPORT_C static TPtrC8 RemoveProp(const TDesC8& aURI);
	...
	*/
	IMPORT_C static TPtrC8 RemoveLastSeg(const TDesC8& aURI);
	...
	* @return 		 		The aLocationth URI segment
	*/
	IMPORT_C static TPtrC8 URISeg(const TDesC8& aURI,TInt aLocation);
	...
	*/
	IMPORT_C static TInt NumOfURISegs(const TDesC8& aURI);
	};
