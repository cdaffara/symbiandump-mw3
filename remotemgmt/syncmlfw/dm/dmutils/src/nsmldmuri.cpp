...
// ------------------------------------------------------------------------------------------------
EXPORT_C TPtrC8 NSmlDmURI::ParentURI(const TDesC8& aURI)
	{
...
// ------------------------------------------------------------------------------------------------
EXPORT_C TPtrC8 NSmlDmURI::LastURISeg(const TDesC8& aURI)
	{
	TInt i;
	for(i=aURI.Length()-1;i>=0;i--)
		{
...
// ------------------------------------------------------------------------------------------------
EXPORT_C TPtrC8 NSmlDmURI::RemoveDotSlash(const TDesC8& aURI)
	{
...
// ------------------------------------------------------------------------------------------------
EXPORT_C TPtrC8 NSmlDmURI::RemoveProp(const TDesC8& aURI)
	{
...
// ------------------------------------------------------------------------------------------------
EXPORT_C TPtrC8 NSmlDmURI::RemoveLastSeg(const TDesC8& aURI)
	{
	TInt i;
	for(i=aURI.Length()-1;i>=0;i--)
		{
...
// ------------------------------------------------------------------------------------------------
EXPORT_C TPtrC8 NSmlDmURI::URISeg(const TDesC8& aURI,TInt aLocation)
	{
	TInt begin=0;
	TInt end;
	TInt num=0;
...
// ------------------------------------------------------------------------------------------------
EXPORT_C TInt NSmlDmURI::NumOfURISegs(const TDesC8& aURI)
	{
	TInt numOfURISegs = 1;
