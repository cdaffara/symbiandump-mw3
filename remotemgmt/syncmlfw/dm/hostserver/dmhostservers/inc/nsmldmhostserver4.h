...
#ifndef __NSMLDMHOSTSERVER4_H__
#define __NSMLDMHOSTSERVER4_H__
...
/**
* Class CNSmlDMHostServer4.
*
* @lib In order to use this class, launch nsmldmhostserver4 (.exe)
*/
class CNSmlDMHostServer4 : public CNSmlDMHostServer
	{
public:
	...
	*/
	static CNSmlDMHostServer4* NewL ( const TDesC& aServerName );
