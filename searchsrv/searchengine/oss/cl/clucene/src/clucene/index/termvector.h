...
public:
	...
	// This magic is needed for RCVT 2.2 compiler - static variables are not
	// constructed
	typedef Array<TermVectorOffsetInfo> TVOIA; 
	DECL_STATMVAR1(TVOIA,EMPTY_OFFSET_INFO)
#define EMPTY_OFFSET_INFO GetInstanceTVOIAEMPTY_OFFSET_INFO()
#else
...
#if defined (__SYMBIAN32__) && defined (RVCT22_STATICS_WORKAROUND)
	typedef Array<int32_t> INT32A;
	DECL_STATMVAR1(INT32A,EMPTY_TERM_POS)
#define EMPTY_TERM_POS GetInstanceINT32AEMPTY_TERM_POS()
#else
