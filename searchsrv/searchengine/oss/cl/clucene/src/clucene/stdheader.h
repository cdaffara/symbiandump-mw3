...
extern void _lucene_shutdown_leave_memtrace_infra();
extern void _lucene_finalize_shutdown();
#endif // defined (__SYMBIAN32__) && defined (RVCT22_STATICS_WORKAROUND)
...
#include "CLucene/LuceneThreads.h" //lucene threading support
